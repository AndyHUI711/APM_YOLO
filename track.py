...
def parse_opt():
    ...
    parser.add_argument('--yolo-weights', nargs='+', type=Path, default=WEIGHTS / 'yolov8m.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--source', type=str, default='test_videos/Go_pass.mp4',
